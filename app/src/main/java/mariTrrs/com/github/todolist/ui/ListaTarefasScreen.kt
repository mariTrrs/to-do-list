...
fun ListaTarefasContent(
    ...
    var tarefaParaExcluir by remember(tarefaParaExcluirInicial) {
        mutableStateOf(tarefaParaExcluirInicial)
    }
...
private fun ConfirmacaoExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = {
            Text("A tarefa \"$tituloTarefa\" será excluída. Esta ação não pode ser desfeita.")
        },
        confirmButton = {
...
private fun ListaTarefasContentPreview() {
    ListaTarefasContent(
        tarefas = listOf(
            ...
            Tarefa(id = 2, titulo = "Enviar atividade", descricao = "Upload no portal", concluida = true)
        ),
        onNovaTarefa = {},
        onEditarTarefa = {},
        onCheckedChange = { _, _ -> },
...
private fun TarefaItemConcluidaPreview() {
    TarefaItem(
        tarefa = Tarefa(id = 2, titulo = "Enviar atividade", descricao = "Upload no portal", concluida = true),
        onCheckedChange = {},
        onEditar = {},
        onDeletar = {}
    )
...
private fun ListaTarefasContentConfirmacaoExclusaoPreview() {
    ...
    ListaTarefasContent(
        ...
        onCheckedChange = { _, _ -> },
        onDeletar = {},
        tarefaParaExcluirInicial = tarefa
    )
}
